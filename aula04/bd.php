        ...
        <div class="container mx-auto py-8">
            ...
            <form method="POST" class="max-w-lg">           
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="cidade" name="cidade" required="form-input mt-1 block w-full">
                </div> 

                <div class="mb-4">
                    <label for="bairro" class="block text-gray-700">Bairro:</label>
                    <input type="text" id="bairro" name="bairro" required="form-input mt-1 block w-full">
                </div> 
